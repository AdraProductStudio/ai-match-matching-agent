                  <>
                          ...
                          <Container className='main-section' fluid style={{overflow:'hidden'}} >
                            <Container className='main-section-container d-flex flex-column justify-content-center align-items-center  bg-danger'>
                                <div className="chat-container ">
                                    <div className="Adra-MR-online-status-container position-fixed top-0 bg-info w-100">
